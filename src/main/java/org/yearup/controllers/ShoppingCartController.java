...
@RequestMapping("/cart") // add the annotation to make this controller the endpoint for the following url : http://localhost:8080/cart
...
public class ShoppingCartController
{
    ...
    // each method in this controller requires a Principal object as a parameter (principal = a user)
    @GetMapping
    ...
    // add a DELETE method to clear all products from the current users cart : https://localhost:8080/cart
    @DeleteMapping("/cart")
    @PreAuthorize("isAuthenticated()")
